class Twitter {
    //look how they take the most recent tweets,and then move pointers
    int count;
...
public:
    ...
    vector<int> getNewsFeed(int userId) {
        ...
        // always use this Heap+ add all last + then remove then add second last 
        // technique for top 10/bottom 10 problems
